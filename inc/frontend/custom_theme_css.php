...
if(!empty($result_fonts)){
    foreach ($result_fonts as $key => $value) {
        wp_enqueue_style( 'edn-google-fonts'.$key.'', '//fonts.googleapis.com/css?family=' . $value, true, APMM_TD );?>
        <?php
    }
}
?>
<?php wp_enqueue_style( 'edn-google-fonts-style-css', '//fonts.googleapis.com/css?family=' . $fonts_final, true, APMM_TD );
wp_enqueue_style( 'edn-google-fonts-style2-css', '//fonts.googleapis.com/css?family=' . $fonts_final1, true, APMM_TD );
wp_enqueue_style( 'edn-google-fonts-style3-css', '//fonts.googleapis.com/css?family=' . $fonts_final2, true, APMM_TD );
wp_enqueue_style( 'edn-google-fonts-style4-css', '//fonts.googleapis.com/css?family=' . $fonts_final3, true, APMM_TD );
wp_enqueue_style( 'edn-google-fonts-style5-css', '//fonts.googleapis.com/css?family=' . $fonts_final4, true, APMM_TD );
?>
<style>
<?php if($enable_menu_background == 1){?>
.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?>.wpmm-orientation-horizontal,
.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?>.wpmm-orientation-vertical{
background: <?php echo esc_attr($menu_background_from);?>;
...
.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> .wpmm-sub-menu-wrap ul li h4.wpmm-mega-block-title::before, 
.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> .wpmm-sub-menu-wrap ul li.wp-mega-menu-header > a.wp-mega-menu-link::before {
    background:  <?php echo esc_attr($menu_background_from);?>;
    bottom: 0;
    content: "";
    height: 1px;
...
.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?>.wpmm-orientation-horizontal,
.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?>.wpmm-orientation-vertical{
border-radius: <?php echo esc_attr($border_radius_topleft);?> <?php echo esc_attr($border_radius_topright);?> <?php echo esc_attr($border_radius_bottomright) ;?> <?php echo esc_attr($border_radius_bottomleft);?>;
<?php if($border_color != ''){?>
...
<?php } ?>
.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?>.wpmm-orientation-horizontal ul.wpmm-mega-wrapper{
...
<?php } ?>
.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?>.wpmm-orientation-horizontal ul.wpmm-mega-wrapper > li > a, 
.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?>.wpmm-orientation-vertical ul.wpmm-mega-wrapper > li > a{
...
.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?>.wpmm-orientation-horizontal ul.wpmm-mega-wrapper > li > a,
.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?>.wpmm-orientation-vertical ul.wpmm-mega-wrapper > li > a{
<?php if($font_size != '' && $font_size != '0px'){ ?>font-size: <?php echo esc_attr($font_size);?>; <?php } ?>
<?php if($font_family != ''){ ?>font-family: <?php echo esc_attr($font_family);?>;<?php } ?>
<?php if($font_weight != ''){ ?>font-weight: <?php echo esc_attr($font_weight);?>;<?php } ?>
<?php if($line_height != ''){ ?>line-height: <?php echo esc_attr($line_height);?>;<?php } ?>
<?php if($transform != ''){ ?>text-transform: <?php echo esc_attr($transform);?> !important;<?php } ?>
<?php if($font_decoration1 != ''){ ?>text-decoration: <?php echo esc_attr($font_decoration1);?>;<?php } ?>
}

<?php if($padding_top != '0px' && $padding_right != '0px' && $padding_bottom != '0px' && $padding_left != '0px'){?>
.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?>.wpmm-orientation-horizontal ul.wpmm-mega-wrapper > li > a{
padding: <?php echo esc_attr($padding_top);?> <?php echo esc_attr($padding_right);?> <?php echo esc_attr($padding_bottom);?> <?php echo esc_attr($padding_left);?>;
}
<?php } ?>

<?php if($enable_background_hover1 == 1){?>
    .wpmm_megamenu .wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?>.wpmm-orientation-horizontal ul.wpmm-mega-wrapper > li:hover,
    .wpmm_megamenu .wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?>.wpmm-orientation-vertical ul.wpmm-mega-wrapper > li:hover{
    background: <?php echo esc_attr($background_hover_from1);?>;
}
<?php }?>

.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> ul.wpmm-mega-wrapper > li:hover > a{
    font-weight: <?php echo esc_attr($font_weight_hover1);?>;
    text-decoration: <?php echo esc_attr($font_decoration_hover1);?>;
}

/*menu divider enable*/
<?php if($enable_menu_divider == 1){
    if($menu_divider_color != ''){?>
.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?>.wpmm-orientation-horizontal ul.wpmm-mega-wrapper > li > a::before{
  background: <?php echo esc_attr($menu_divider_color);?>;
    opacity: <?php echo esc_attr($opacity_glow);?>;
      content: "";
    height: 100%;
    position: absolute;
    right: 0;
...
.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> .wpmm-mega-wrapper > li.current-menu-item{
background: <?php echo esc_attr($bg_active_color1);?>
}
<?php } ?>

.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> .wpmm-mega-wrapper > li.current-menu-item > a{
    color: <?php echo esc_attr($font_color_active1);?> !important;
}

/*Mega menu */

<?php if($enable_megamenu_background2 == 1){?>
.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?>.wpmm-orientation-horizontal ul.wpmm-mega-wrapper li .wpmm-sub-menu-wrap,
.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?>.wpmm-orientation-vertical ul.wpmm-mega-wrapper li .wpmm-sub-menu-wrap{
background: <?php echo esc_attr($menu_background_from2);?>;
}
...
.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?>.wpmm-orientation-vertical ul.wpmm-mega-wrapper li .wpmm-sub-menu-wrap{
 ...
 padding-top:<?php echo esc_attr($padding_top2);?>;
 padding-bottom:<?php echo esc_attr($padding_bottom2);?>;
 padding-left:<?php echo esc_attr($padding_left2);?>;
 padding-right: <?php echo esc_attr($padding_right2);?>;
 border: 1px solid <?php echo esc_attr($border_color2);?>;
 border-radius: <?php echo esc_attr($border_radius2);?>;
 box-shadow: <?php echo esc_attr($box_shadow2);?> <?php echo esc_attr($box_shadow_color2);?>;
}

/*Widget section*/
.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> .wpmm-sub-menu-wrap ul li h4.wpmm-mega-block-title, 
.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> .wpmm-sub-menu-wrap ul li.wp-mega-menu-header > a.wp-mega-menu-link span.wpmm-mega-menu-href-title{
color: <?php echo esc_attr($font_color3);?>;
font-size: <?php echo esc_attr($font_size3);?>;
font-weight: <?php echo esc_attr($font_weight3);?>;
text-transform: <?php echo esc_attr($transform3);?>;
font-family: <?php echo esc_attr($font_family3);?>;
text-decoration: <?php echo esc_attr($font_decoration3);?>;
margin-bottom:<?php echo esc_attr($margin_bottom3);?>;
margin-top:<?php echo esc_attr($margin_top3);?>; 
}

.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> .wpmm-sub-menu-wrap ul li h4.wpmm-mega-block-title:hover, 
.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> .wpmm-sub-menu-wrap ul li.wp-mega-menu-header > a.wp-mega-menu-link span.wpmm-mega-menu-href-title:hover{
color: <?php echo esc_attr($font_hover_color3);?>;
font-weight: <?php echo esc_attr($font_weight_hover3);?>;
text-decoration: <?php echo esc_attr($font_decoration_hover3);?>;
cursor: pointer;

}

.wpmm_megamenu .wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> .wpmm-sub-menu-wrap ul li {
   color: <?php echo esc_attr($content_font_color3);?>;
   /*font-size: <?php echo esc_attr($content_font_size3);?>;*/
   font-family: <?php echo esc_attr($content_font_family3);?>;
}
.wpmm_megamenu .wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> ul.wpmm-mega-wrapper
 li .wpmm-sub-menu-wrap ul.wp-mega-sub-menu > li > a{
    color: <?php echo esc_attr($content_font_color3);?>;
   font-family: <?php echo esc_attr($content_font_family3);?>;
}
 .wpmm_megamenu .wpmm_megamenu .wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> .wpmm-sub-menu-wrap ul li{
    font-size: <?php echo esc_attr($content_font_size3);?>;
}

  <?php if($content_font_color3 != ''){ ?>
     .wpmm_megamenu .wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> ul.wpmm-mega-wrapper li ul.wp-mega-sub-menu li div.woocommerce ul.products li a h3{
    color: <?php echo esc_attr($content_font_color3);?>;
  }
  /*.wpmm_megamenu .wpmm_megamenu .wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> .woocommerce ul.cart_list li a, .wpmm_megamenu .woocommerce ul.product_list_widget li a*/
  .wpmm_megamenu .wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> ul.wpmm-mega-wrapper li ul.wp-mega-sub-menu li div.woocommerce ul.products li a span.price ins,
   .wpmm_megamenu .wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> ul.wpmm-mega-wrapper li ul.wp-mega-sub-menu li div.woocommerce ul.products li a span.price .woocommerce-Price-amount{
color: <?php echo esc_attr($content_font_color3);?>;
  }


.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> .wp-mega-sub-menu li .wpmm-sub-menu-wrapper.wpmm_menu_1 li::before, 
.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> .wp-mega-sub-menu .widget_pages li::before, 
.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> .wp-mega-sub-menu .widget_categories li::before,
 .wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> .wp-mega-sub-menu .widget_archive li::before, 
 .wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> .wp-mega-sub-menu .widget_meta li::before, 
 .wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> .wp-mega-sub-menu .widget_recent_comments li::before, 
 .wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> .wp-mega-sub-menu .widget_recent_entries li::before,
 .wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> .wp-mega-sub-menu .widget_product_categories ul.product-categories li a::before, 
 .wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> .wp-mega-sub-menu .widget_categories li::before, 
.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> .wp-mega-sub-menu .widget_archive li::before{
    color: <?php echo esc_attr($content_font_color3);?>;
}
    .wpmm_megamenu .wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> ul ul li a:hover,
 .wpmm_megamenu .wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> ul ul li a,
  .wpmm_megamenu .wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> ul ul li a:focus{
color: <?php echo esc_attr($content_font_color3);?>;
  }
  .wpmm_megamenu .wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> ul.wp-mega-sub-menu li.wpmm-custom-post-settings.wpmega-image-left .wpmm-custom-postimage span.wpmm-mega-menu-href-title, 
  .wpmm_megamenu .wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> ul.wp-mega-sub-menu li.wpmm-custom-post-settings.wpmega-image-top .wpmm-custom-postimage span.wpmm-mega-menu-href-title{
color: <?php echo esc_attr($content_font_color3);?>;
  }
...
*/
.wpmm_megamenu .wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> ul.wpmm-mega-wrapper li .wpmm-sub-menu-wrap span.wpmm_megamenu_topcontent{
    font-size :<?php echo esc_attr($font_size4);?>;
    color:<?php echo esc_attr($font_color4);?>;
    font-family: <?php echo esc_attr($font_family4);?>;
    font-weight: <?php echo esc_attr($font_weight4);?>;
    text-transform: <?php echo esc_attr($transform4);?>;
    margin-left: <?php echo  esc_attr($image_margin_left4);?>;
    margin-right: <?php echo  esc_attr($image_margin_right4);?>;
}

.wpmm_megamenu .wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> ul.wpmm-mega-wrapper li .wpmm-sub-menu-wrap .top_clearfix{
    margin-bottom: <?php echo esc_attr($image_margin_bottom4);?>;
    
}

.wpmm_megamenu .wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> ul.wpmm-mega-wrapper li .wpmm-sub-menu-wrap .wpmm-topimage{
    margin-left: <?php echo esc_attr($image_margin_left4);?>;
    margin-right: <?php echo esc_attr($image_margin_right4);?>;
    margin-top: <?php echo esc_attr($image_margin_top4);?>;
}

.wpmm_megamenu .wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> ul.wpmm-mega-wrapper li .wpmm-sub-menu-wrap .wpmm-ctop{
    margin-left: <?php echo esc_attr($image_margin_left4);?>;
    margin-right: <?php echo esc_attr($image_margin_right4);?>;
    margin-top: <?php echo esc_attr($image_margin_top4);?>;
}
...
*/
.wpmm_megamenu .wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> ul.wpmm-mega-wrapper li .wpmm-sub-menu-wrap span.wpmm_megamenu_bottomcontent{
    font-size :<?php echo esc_attr($font_size5);?>;
    color:<?php echo esc_attr($font_color5);?>;
    font-family: <?php echo esc_attr($font_family5);?>;
    font-weight: <?php echo esc_attr($font_weight5);?>;
    text-transform: <?php echo esc_attr($transform5);?>;
    margin-left: <?php echo esc_attr($image_margin_left5);?>;
    margin-right: <?php echo esc_attr($image_margin_right5);?>;
}

.wpmm_megamenu .wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> ul.wpmm-mega-wrapper li .wpmm-sub-menu-wrap .bottom_clearfix{
    margin-top: <?php echo esc_attr($image_margin_top5);?>;
}


.wpmm_megamenu .wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> ul.wpmm-mega-wrapper li .wpmm-sub-menu-wrap .wpmm-bottomimage{
    margin-left: <?php echo esc_attr($image_margin_left5);?>;
    margin-right: <?php echo esc_attr($image_margin_right5);?>;
    margin-bottom: <?php echo esc_attr($image_margin_bottom5);?>;
}

.wpmm_megamenu .wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> ul.wpmm-mega-wrapper li .wpmm-sub-menu-wrap .wpmm-cbottom{
       margin-left: <?php echo esc_attr($image_margin_left5);?>;
       margin-right: <?php echo esc_attr($image_margin_right5);?>;
       margin-bottom: <?php echo esc_attr($image_margin_bottom5);?>;
}
...
.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> ul.wpmm-mega-wrapper li.wpmega-menu-flyout ul{
    background: <?php echo esc_attr($menu_bgcurrentcolor6);?>;
}
<?php }?>
.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> ul.wpmm-mega-wrapper li.wpmega-menu-flyout ul{
    width: <?php echo esc_attr($item_width6);?>;
}
.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> ul.wpmm-mega-wrapper li.wpmega-menu-flyout ul.wp-mega-sub-menu li:hover > a {
    background: <?php echo esc_attr($menu_bg_hovercolor6);?>;
}
.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> ul.wpmm-mega-wrapper li.wpmega-menu-flyout.wpmega-flyout-horizontal-left ul.wp-mega-sub-menu li{
    margin: <?php echo esc_attr($item_margin6);?>;
}

.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> ul.wpmm-mega-wrapper li.wpmega-menu-flyout.wpmega-flyout-horizontal-left ul.wp-mega-sub-menu li a.wp-mega-menu-link {
    padding:<?php echo esc_attr($item_padding6);?>;
}

.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> ul.wpmm-mega-wrapper li.wpmega-menu-flyout ul.wp-mega-sub-menu li a {
    color: <?php echo esc_attr($font_color6);?>;
    font-size: <?php echo esc_attr($font_size6);?>;
    font-weight: <?php echo esc_attr($font_weight6);?>;
    text-transform: <?php echo esc_attr($transform6);?>;
    font-family: <?php echo esc_attr($font_family6);?>;
    text-decoration: <?php echo esc_attr($font_decoration6);?>;
}

.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> ul.wpmm-mega-wrapper li.wpmega-menu-flyout ul.wp-mega-sub-menu li:hover a {
    color: <?php echo esc_attr($font_hover_color6);?>;
    font-weight: <?php echo esc_attr($font_weight_hover6);?>;
    text-decoration: <?php echo esc_attr($font_decoration_hover6);?>;
}

/* search bar */
 .wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> ul.wpmm-mega-wrapper li.wpmm-menu-align-right.wpmm-search-type .wpmm-sub-menu-wrap
 .megamenu-type-search input.search-submit[type="submit"]{
 font-size: <?php echo esc_attr($font_size7);?>;
 color: <?php echo esc_attr($text_color7);?>;
 background: <?php echo esc_attr($bg_color7);?>;
 }

  .wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> ul.wpmm-mega-wrapper 
  li.wpmm-menu-align-right.wpmm-search-type .wpmm-sub-menu-wrap .megamenu-type-search input.search-field[type="search"]{
width: <?php echo esc_attr($width7);?>;
color: <?php echo esc_attr($text_placholder_color7);?>;
 }


<?php if($icon_color7 != '' ){?>
 .wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> .wpmm-search-type  > .wpmm-mega-menu-icon > i.fa-search,
 .wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> .wpmm-search-type  > .wpmm-mega-menu-icon > i.genericon-search,
 .wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> .wpmm-search-type  > .wpmm-mega-menu-icon > i.dashicons-search{
  color:  <?php echo esc_attr($icon_color7);?>;

}
<?php }else{ ?>
 .wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> a.wpmm-search-type > .wpmm-mega-menu-icon > i.fa-search,
 .wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> .wpmm-search-type  > .wpmm-mega-menu-icon > i.genericon-search,
 .wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> .wpmm-search-type  > .wpmm-mega-menu-icon > i.dashicons-search{
  color: <?php echo esc_attr($font_color);?>;
}
...
<?php } ?>
 .wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> .wpmm-mega-wrapper .wpmega-searchinline input.search-field{
  width: <?php echo esc_attr($width7);?>;
}

/* menu label custom css */
<?php if($enable_menu_label_bgcolor == 1){ ?>
.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> .wpmm-mega-menu-label::before {
    <?php if($menu_label_bgcolor != ''){ ?>
  border-color: <?php echo esc_attr($menu_label_bgcolor);?> transparent transparent;
  <?php } ?>
}

.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> .wpmm-sub-menu-wrap ul.wp-mega-sub-menu li.wp-mega-menu-header a span.wpmm-mega-menu-label{
   <?php if($menu_label_fontsize != ''){ ?>
  font-size:<?php echo esc_attr($menu_label_fontsize);?>px;
    <?php } ?>
  <?php if($menu_label_fontcolor != ''){ ?>
  color:<?php echo esc_attr($menu_label_fontcolor);?>;
  <?php } ?>
}

.wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> .wpmm-mega-menu-label {
    <?php if($menu_label_bgcolor != ''){ ?>
  background: <?php echo esc_attr($menu_label_bgcolor);?>;
  <?php } ?>
  <?php if($menu_label_fontcolor != ''){ ?>
  color:<?php echo esc_attr($menu_label_fontcolor);?>;
  <?php } ?>
...
<?php if($menu_label_font_weight != ''){ ?>
  font-weight: <?php echo esc_attr($menu_label_font_weight);?>;
   <?php } ?>
  <?php if($menu_label_font_transform != ''){ ?>
  text-transform: <?php echo esc_attr($menu_label_font_transform);?>;
     <?php } ?>
  <?php if($menu_label_font_family != ''){?>
   font-family: <?php echo esc_attr($menu_label_font_family);?>
    <?php } ?>
}
<?php }?>
...
@media (max-width: <?php echo esc_attr($resposive_breakpoint_width);?>){
    <?php if($togglebar_enable_bgcolor == 1){ ?>
        ...
        .wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> .wpmegamenu-toggle{
            display: block !important;
            height: <?php echo esc_attr($togglebar_height);?>;
            background: <?php echo esc_attr($togglebar_background_from);?>;
            text-align:  <?php echo esc_attr($togglebar_align);?>;
        }   

        .wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> .wpmegamenu-toggle .wpmega-closeblock{
                     display: none;
        }
    ...
    <?php if($icon_color != ''){?>
      .wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> .wpmegamenu-toggle .wpmega-openblock,
      .wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> .wpmegamenu-toggle .wpmega-closeblock{
         color: <?php echo  esc_attr($icon_color);?>;
           }
     <?php } ?>
<?php if($text_color != ''){?>
     .wp-megamenu-main-wrapper.wpmm-ctheme-wrapper<?php echo esc_attr($theme_slug);?> .close-primary{
