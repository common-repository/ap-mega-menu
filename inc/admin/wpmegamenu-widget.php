    ...
    class WP_Mega_Menu_Widget extends WP_Widget {
        ...
        public function form($instance) {
            ...
            <p>
                <?php if ($locations) { ?>
                <p>
                    <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php _e('Title:', APMM_TD); ?></label>
                    <input class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" type="text" value="<?php echo esc_attr($title); ?>" />
                </p>
                <label for="<?php echo esc_attr($this->get_field_id('location')); ?>"><?php _e('Menu Location:', APMM_TD); ?></label>
                <select id="<?php echo esc_attr($this->get_field_id('location')); ?>" name="<?php echo esc_attr($this->get_field_name('location')); ?>">
                    <?php
...
if (!class_exists('WP_Mega_Menu_Contact_Info')) :
    ...
    class WP_Mega_Menu_Contact_Info extends WP_Widget {
        ...
        public function widget($args, $instance) {
            ...
            if (isset($instance['address_font_icon']) || isset($instance['address'])) {
                ...
                if (isset($instance['address_font_icon']) && $instance['address_font_icon'] != '') {
                    echo "<i class='" . esc_attr($instance['address_font_icon']) . "'></i>";
                }
            ...
            if (isset($instance['phone_font_icon']) || isset($instance['phone'])) {
                ...
                if (isset($instance['phone_font_icon']) && $instance['phone_font_icon'] != '') {
                    echo "<i class='" . esc_attr($instance['phone_font_icon']) . "'></i>";
                }
            ...
            if (isset($instance['email_font_icon']) || isset($instance['email'])) {
                ...
                if (isset($instance['email_font_icon']) && $instance['email_font_icon'] != '') {
                    echo "<i class='" . esc_attr($instance['email_font_icon']) . "'></i>";
                }
            ...
            if (isset($instance['website_font_icon']) || isset($instance['website'])) {
                ...
                if (isset($instance['website_font_icon']) && $instance['website_font_icon'] != '') {
                    echo "<i class='" . esc_attr($instance['website_font_icon']) . "'></i>";
                }
                if (isset($instance['website']) && $instance['website'] != '') {
                    echo esc_html($instance['website']);
                }
                echo "</p>";
            }
            ...
            if (isset($instance['custom_shortcode_title']) || (isset($instance['custom_shortcode']))) {
                ...
                echo "<h4>" . esc_attr($instance['custom_shortcode_title']) . "</h4>";
        ...
        public function form($instance) {
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('address_font_icon')); ?>"><?php _e('Address Icon:', APMM_TD); ?></label> 
            <p class="description"><?php _e('Use Fontawesome Class for Address Icon such as fa fa-home', APMM_TD); ?></p>
            <input class="widefat" id="<?php echo esc_attr($this->get_field_id('address_font_icon')); ?>" name="<?php echo esc_attr($this->get_field_name('address_font_icon')); ?>" type="text" value="<?php echo esc_attr($address_font_icon); ?>" placeholder="<?php _e('E.g., fa fa-home', APMM_TD); ?>">
            </p>
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('address')); ?>"><?php _e('Address', APMM_TD) ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('phone_font_icon')); ?>"><?php _e('Phone Icon:', APMM_TD); ?></label> 
            <p class="description"><?php _e('Use Fontawesome Class for Phone Icon such as fa fa-phone', APMM_TD); ?></p>
            <input class="widefat" id="<?php echo esc_attr($this->get_field_id('phone_font_icon')); ?>" name="<?php echo esc_attr($this->get_field_name('phone_font_icon')); ?>" type="text" value="<?php echo esc_attr($phone_font_icon); ?>" placeholder="<?php _e('E.g., fa fa-phone', APMM_TD); ?>">
            </p>
            <p>

                <label for="<?php echo esc_attr($this->get_field_id('phone')); ?>"><?php _e('Phone:', APMM_TD); ?></label> 
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('phone')); ?>" name="<?php echo esc_attr($this->get_field_name('phone')); ?>" type="text" value="<?php echo esc_attr($phone); ?>">
            </p>
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('email_font_icon')); ?>"><?php _e('Email Icon:', APMM_TD); ?></label> 
            <p class="description"><?php _e('Use Fontawesome Class for Email Icon such as fa fa-phone', APMM_TD); ?></p>
            <input class="widefat" id="<?php echo esc_attr($this->get_field_id('email_font_icon')); ?>" name="<?php echo esc_attr($this->get_field_name('email_font_icon')); ?>" type="text" value="<?php echo esc_attr($email_font_icon); ?>" placeholder="<?php _e('E.g., fa fa-email', APMM_TD); ?>">
            </p>
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('email')); ?>"><?php _e('Email:', APMM_TD); ?></label> 
            ...
            <p>
                ...
                <label for="<?php echo esc_attr($this->get_field_id('website_font_icon')); ?>"><?php _e('Website Icon:', APMM_TD); ?></label> 
            <p class="description"><?php _e('Use Fontawesome Class for Website Icon such as fa fa-phone', APMM_TD); ?></p>
            <input class="widefat" id="<?php echo esc_attr($this->get_field_id('website_font_icon')); ?>" name="<?php echo esc_attr($this->get_field_name('website_font_icon')); ?>" type="text" value="<?php echo esc_attr($website_font_icon); ?>" placeholder="<?php _e('E.g., fa fa-globe', APMM_TD); ?>">
            </p>
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('website')); ?>"><?php _e('Website:', APMM_TD); ?></label> 
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('custom_shortcode_title')); ?>"><?php _e('Custom Title', APMM_TD) ?></label>
                <input type="text" class="widefat" id="<?php echo esc_attr($this->get_field_id('custom_shortcode_title')); ?>" name="<?php echo esc_attr($this->get_field_name('custom_shortcode_title')); ?>" value="<?php echo esc_attr($custom_shortcode_title); ?>"/>
            </p>

            <p>
                <label for="<?php echo esc_attr($this->get_field_id('custom_shortcode')); ?>"><?php _e('Custom Shortcode', APMM_TD) ?></label>
                <textarea class="widefat" id="<?php echo esc_attr($this->get_field_id('custom_shortcode')); ?>" name="<?php echo esc_attr($this->get_field_name('custom_shortcode')); ?>"><?php echo esc_attr($custom_shortcode); ?></textarea>
            </p>
            <?php
        }
       ...
       <div class="wpmm-image-link-wrapper">
        <a href="<?php echo esc_url($url_link);?>" target="<?php echo esc_attr($linktarget);?>">
          <img src="<?php echo esc_url($customimage);?>" class="wpmm-custom-image" <?php if($cwidth != '' || $cheight != '') 
           echo 'style="width:'.esc_attr($cwidth).'px;height:'.esc_attr($cheight).'px"';?>>
        </a>
      </div>
       <?php 
         }
    ...
    public function form( $instance ) {
       ...
       <p>  
        ...
        <input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'title' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'title' )); ?>" type="text" value="<?php echo esc_attr( $title ); ?>">
            ...
            <p>
              <label for="<?php echo esc_attr($this->get_field_id('url_link'));?>"><?php _e('URL Link',APMM_TD)?></label>
            ...
            <p>
            <label for="<?php echo esc_attr($this->get_field_id('customimage'));?>"><?php _e('Choose Custom Image',APMM_TD)?></label>
             <input type="hidden" class="widefat wpmm-image-url" id="<?php echo esc_attr($this->get_field_id( 'customimage' )); ?>"
            ...
            <input type="button" class="wpmm_image_url button button-primary button-large"
             id="<?php echo esc_attr($this->get_field_id( 'customimage' )); ?>" name="wpmm_image_url"  value="Upload Image" 
            size="25"/> 
            <br/>
               <img style="width: 15%;" class="wpmm-image" src="<?php echo esc_url( $customimage ); ?>">
            </p>
             <p>
              <label for="<?php echo esc_attr($this->get_field_id('cwidth'));?>"><?php _e('Custom Width',APMM_TD)?></label>
             ...
             <p>
              <label for="<?php echo esc_attr($this->get_field_id('cheight'));?>"><?php _e('Custom Height',APMM_TD)?></label>
...
/**
   ...
   public function widget($args, $instance) {
       ...
       ?>
         ...
         <div class="textwidget"><?php echo esc_html($text); ?></div>
       <?php 
        echo $args['after_widget'];
    }
  ...
  function update( $new_instance, $old_instance ) {
    ...
    public function form( $instance ) {
       ...
       <p>  
        ...
        <p>
              <label for="<?php echo esc_attr($this->get_field_id('content'));?>"><?php _e('Content',APMM_TD)?></label>
             <textarea rows="16" cols="20" class="widefat text wp-editor-area" style="height: 200px" id="<?php echo esc_attr($this->get_field_id( 'content' )); ?>"
