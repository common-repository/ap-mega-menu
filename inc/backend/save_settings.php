...
$apmega_settings['custom_css']              = (isset($_POST['custom_css']) && $_POST['custom_css'] != '') ? sanitize_text_field($_POST['custom_css']):'';
$apmega_settings['custom_js']              = (isset($_POST['custom_js']) && $_POST['custom_js'] != '') ? sanitize_text_field($_POST['custom_js']):'';
