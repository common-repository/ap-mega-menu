		  ...
		  <tr>
			<td class="wpmm_meta_table"><label for="menu_icon"><?php _e("Show Menu Icon", APMM_TD) ?></label></td>
			  ...
			  <div class="wpmm-switch">
			      ...
			      name='wpmm_settings[general_settings][menu_icon]' value='enabled' <?php echo checked($wpmmenu_item_meta['general_settings']['menu_icon'],'enabled', false ); ?>/>
			...
			<td class="wpmm_meta_table"><label for="active_single_menu"><?php _e("Active Single Menu", APMM_TD) ?></label></td>
			  ...
			  <div class="wpmm-switch">
			      ...
			      name='wpmm_settings[general_settings][active_single_menu]' value='enabled' <?php echo checked($wpmmenu_item_meta['general_settings']['active_single_menu'],'enabled', false ); ?>/>
			...
			<tr>
				...
				<td class='apmega-value'>
				   ...
				   <input type="text" name="wpmm_settings[general_settings][top_menu_label]" value="<?php echo esc_attr($topmenulabel);?>" placeholder="<?php _e('E.g., HOT!',APMM_TD);?>">
