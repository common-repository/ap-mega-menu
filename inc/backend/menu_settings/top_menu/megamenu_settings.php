 ...
 <!-- top content start-->
          ...
          <!-- case 1: only text here -->
			<tr class="toggle_toptext" <?php echo esc_attr($text_only);?>>
           ...
           <!-- case 2: only image here -->
			<tr class="toggle_topimage" id="top_image" <?php echo esc_attr($image_only);?>>
			<td class="wpmm_meta_table"><label><?php _e("Top Image", APMM_TD) ?></label></td>
			  <td> 
			    <div class="wpmm-option-field">
                      ...
                      src="<?php echo (isset( $wpmmenu_item_meta['mega_menu_settings']['top']['image_url']) && $wpmmenu_item_meta['mega_menu_settings']['top']['image_url'] != '')?esc_url($wpmmenu_item_meta['mega_menu_settings']['top']['image_url']):'';?>" 
                      alt="">
                      </div>
                </div>   
			  </td>
			...
			<tr class="toggle_html" id="top_imagetext" <?php echo esc_attr($html);?>>
 ...
 <!-- top content end-->
     ...
     <!-- bottom content -->
          ...
          <!-- case 1: only text here -->
			<tr class="toggle_bottomtext" <?php echo esc_attr($bottomtext_only);?>>
           ...
           <!-- case 2: only image here -->
			<tr class="toggle_bimage" id="bottom_image" <?php echo esc_attr($bottomimage_only);?>>
			<td class="wpmm_meta_table"><label><?php _e("Bottom Image", APMM_TD) ?></label></td>
		              ...
		              <input type="button" class="wpmm_image_url_bottom button button-primary button-large" id="bottom_image" name="wpmm_image_url_bottom"  value="Upload Image" size="25"/> 
		               ...
		               <div class="wpmm-option-field wpmm-bimage-preview">
						...
						<i class="dashicons dashicons-trash"></i>
                         ...
                         src="<?php echo (isset( $wpmmenu_item_meta['mega_menu_settings']['bottom']['image_url']) && $wpmmenu_item_meta['mega_menu_settings']['bottom']['image_url'] != '')?esc_url($wpmmenu_item_meta['mega_menu_settings']['bottom']['image_url']):'';?>">
			 ...
			 <!-- case 3: image with text here -->
			<tr class="toggle_bhtml" id="bottom_html_only" <?php echo esc_attr($bottomhtml);?>>
