				  ...
				  <?php $image_sizes = APMM_Class::wpmm_get_image_sizes(); ?> 
                         ...
                         foreach ($image_sizes as $size_name => $key): 
                          ?>
                            ...
                            value="<?php echo esc_attr($size_name);?>" name="wpmm_settings[upload_image_settings][image_size]">
                           <label for="ap_<?php echo esc_attr($size_name);?>_imagesize" class="image_label"><?php echo ucwords($size_name);?></label>
                           <br>
                            <p class="description"><?php _e('Registered image size:',APMM_TD);?> <?php echo esc_html($size_name);?> <?php echo esc_html($key['width'].' * '.$key['height']);?></p>
                           <?php endforeach; 
                           endif;
                           ?>
				 </td>
