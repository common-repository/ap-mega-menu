				  ...
				  <td> 
				       <div class="topicons">
				           ...
				           <input class="wpmm-icon-picker" type="hidden" id="icon_picker_icon1" name="wpmm_settings[icons_settings][icon_choose]" id="selected_font_icon" 
											value="<?php echo esc_attr($attr_class);?>"/>
							<div class="icon-preview">
								<i class="<?php if( isset( $attr_class ) ) { $v=explode('|',$attr_class); echo esc_attr($v[0].' '.$v[1]); } ?>"></i>
							</div>
							<div class="icon-main">
							<input type="hidden" id="current_selection" value="fontawesome"/>
								...
								<div class="font-awesome-icon" id="fontawesome">
									  ...
									  <?php 
										...
										<div class="icon" id="<?php echo esc_attr('icon-' . $key);?>" title="<?php echo esc_attr($key); ?>">
											<i class="<?php echo esc_attr('fa fa-' . $key); ?>"></i>
										</div>
								...
								<div class="genericon-icon" id="genericon">
									...
									?>
										...
										<div class="icon" id="<?php echo esc_attr('icon-' . $key);?>" title="<?php echo esc_attr($key); ?>">
											<i class="genericon genericon-<?php echo esc_attr($key); ?>"></i>
										</div>
							   ...
							   <div class="dash-icon" id="dashicon">
									...
									?>
										...
										<div class="icon" id="<?php echo esc_attr('icon-' . $key);?>" title="<?php echo esc_attr($key); ?>">
											<i class="<?php echo esc_attr('dashicons dashicons-' . $key); ?>"></i>
										</div>
