                 ...
                 <ul><?php 
                  ...
                  $all_widgets = $wpmm_widget_manager->wpmm_get_available_widgets();
                    foreach ($all_widgets as $key => $value) { ?>
                     <li class="wpmm_all_wp_widgets" data-value="<?php echo esc_attr($value['value']);?>" data-text="<?php echo esc_attr($value['text']);?>">
                       <div class="wpmm_widget-type-wrapper" style="height:70px;">
                         <span class="wpmm_widget-icon dashicons dashicons-wordpress"></span>
                          <h3><?php echo esc_attr($value['text']);?></h3>
                          <p class="widgets_description"><?php echo esc_attr($value['description']);?></p>
                        </div>
                     </li>
                   <?php }
                  ?>
...
?>
  <div class="wpmm_add_components <?php echo esc_attr($class);?>">
          <div id="wpmm_widgets_setup" class="<?php echo esc_attr($class);?>" data-columns="<?php echo (!isset($wpmmenu_item_meta['panel_columns']) && $wpmmenu_item_meta['panel_columns'] == '')?'6':esc_attr($wpmmenu_item_meta['panel_columns']);?>">
